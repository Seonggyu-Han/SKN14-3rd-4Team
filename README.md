...
| 단계                  | 내용 요약                                                                                      |
|----------------------|--------------------------------------------------------------------------------------------|
| 데이터 수집 및 전처리   | 외부 공개 식품DB( **식품의약안전처 공공데이터 조리식품 레시피DB**
https://www.foodsafetykorea.go.kr/api/openApiInfo.do?menu_grp=MENU_GRP31&menu_no=661&show_cnt=10&start_idx=1&svc_no=COOKRCP01)에서 음식 정보, 레시피 데이터 수집                                       |
